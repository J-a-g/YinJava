...
public class member_del_svl extends HttpServlet{
...
//		super.doPost(req, resp);
		...
		JSONObject userJson;
		if(userControl.del_User(Integer.parseInt(uid))) {
			userJson = JSONObject.fromObject(new Response(SysConfig.SUC_CODE, "删除成功", "", "member_del_svl"));
		}else {
			userJson = JSONObject.fromObject(new Response(SysConfig.ERR_CODE, "删除失败", "", "member_del_svl"));
		}
		System.out.println("member_del_svl--->" + userJson.toString());
