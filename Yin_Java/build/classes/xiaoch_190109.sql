...
CREATE TABLE `kitchen` (
  ...
  `kitchenCode` varchar(20) NOT NULL,
  `kitchenName` varchar(255) NOT NULL COMMENT '小厨名字',
...
-- Records of kitchen
-- ----------------------------
INSERT INTO `kitchen` VALUES ('3', '2', '30100000001', '小厨名测试数据', '0', '11111111111', '222222222222', '33333333333', '1', '2', '3', '4', '5', '100', '100', '10', '0.222222', '0.33333', '5', '2018-10-29 00:00:00', '0');
...
CREATE TABLE `operate` (
  ...
  `machine_sn` varchar(15) CHARACTER SET utf8 DEFAULT '',
  `create_time` varchar(15) CHARACTER SET utf8 DEFAULT '',
  `type` int(11) DEFAULT '0' COMMENT 'type:0在线状态更新，1.紧急按钮被触发',
  `mark` varchar(255) CHARACTER SET utf8 DEFAULT '' COMMENT '注释',
  `create_time_2` varchar(20) CHARACTER SET utf8 DEFAULT '',
...
-- Records of operate
-- ----------------------------
INSERT INTO `operate` VALUES ('1', '9999999', '789', '0', 'pspsps', '');
INSERT INTO `operate` VALUES ('2', '999999', '1546964908512', '0', 'testasafds', '');
INSERT INTO `operate` VALUES ('3', '999999', '1546965142524', '0', 'testasafds', '');
INSERT INTO `operate` VALUES ('4', '999999', '1546965167310', '0', 'fkasdjflkafjdl', '');
INSERT INTO `operate` VALUES ('5', '999999', '1546965534240', '0', '阿克苏的flak决定了反拉得分', '');
INSERT INTO `operate` VALUES ('6', '999999', '1546966103247', '0', '阿克苏的flak决定了反拉得分', '20190109 00:48:23');
...
CREATE TABLE `order` (
  ...
  `wechat_uid_business` int(11) NOT NULL,
  `wechat_uid_user` int(11) NOT NULL COMMENT '消费用户的',
  `kitchenId` int(11) NOT NULL,
  `order_status` int(11) NOT NULL DEFAULT '0' COMMENT '处理状态（0未处理、1已接单、2完成, 3.关闭)',
  ...
  `latitude` varchar(20) NOT NULL COMMENT 'Us维度',
  PRIMARY KEY (`orderId`),
  KEY `kitchenId` (`kitchenId`),
  KEY `order_ibfk_2` (`wechat_uid_user`),
  KEY `order_ibfk_3` (`wechat_uid_business`),
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`kitchenId`) REFERENCES `kitchen` (`kitchenId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`wechat_uid_user`) REFERENCES `wechat_info` (`wechat_uid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `order_ibfk_3` FOREIGN KEY (`wechat_uid_business`) REFERENCES `wechat_info` (`wechat_uid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='订单表';

-- ----------------------------
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('1', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx', 'mark1111111111111', '2018-10-29 08:11:11', '2018-10-29 08:30:11', '', '19', '1', '100.5', '19', '1', '3', '0', '0', '0', '116.553172', '39.972023');
INSERT INTO `order` VALUES ('2', 'zzzzzzzzzzzzzzzzzzzzzz', 'mark22222222222222222', '2018-10-29 12:00:11', '2018-10-29 12:30:11', '', '30', '0', '88.8', '19', '2', '3', '0', '0', '0', '0', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='用户信息微信部分的抽象表';
